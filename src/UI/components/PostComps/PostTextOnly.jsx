...
const initialComments = [
    // Пример начальных комментариев (МИРАС ИЗМЕНИ ПОЖАЛУЙСТА С БЭКА)
    { userName: "Василий Антипов", text: "Ну шо ты лысый плаки плаки или нормалдаки?", date: "Вчера в 23:00" },
    { userName: "Олег", text: "Отличный пост!", date: "Вчера в 22:45" },
    { userName: "Анна Иванова", text: "Согласна с предыдущим комментатором.", date: "Вчера в 22:30" },
    { userName: "Сергей", text: "Спасибо за информацию!", date: "Сегодня в 10:15" },
    { userName: "Мария", text: "Очень интересно!", date: "Сегодня в 09:45" },
    { userName: "Дмитрий", text: "Полностью согласен.", date: "Сегодня в 09:30" },
    { userName: "Елена", text: "Хорошая статья.", date: "Сегодня в 09:00" },
    { userName: "Игорь", text: "Много полезной информации.", date: "Сегодня в 08:30" },
    { userName: "Ольга", text: "Буду следить за вашими постами.", date: "Сегодня в 08:00" },
    { userName: "Николай", text: "Спасибо!", date: "Сегодня в 07:30" },
    { userName: "Антон", text: "Отлично!", date: "Сегодня в 07:00" }
];
